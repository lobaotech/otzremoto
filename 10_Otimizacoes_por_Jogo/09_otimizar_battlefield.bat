@echo off
color 0A
title Otimizador Battlefield

echo ==================================================
echo             OTIMIZADOR BATTLEFIELD
echo ==================================================

echo Este script aplica otimizacoes para jogos da serie Battlefield.
echo.
pause

:: Nome do processo do jogo
:: Pode variar dependendo do jogo (ex: bfv.exe, bf1.exe, bf2042.exe)
:: Verifique o Gerenciador de Tarefas para o nome exato do processo do seu jogo.
set GAME_PROCESS=bfv.exe
...
echo ==================================================
echo Otimizacoes para Battlefield aplicadas.

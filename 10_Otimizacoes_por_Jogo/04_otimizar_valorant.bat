@echo off
color 0A
title Otimizador Valorant

echo ==================================================
echo               OTIMIZADOR VALORANT
echo ==================================================

echo Este script aplica otimizacoes para Valorant.
echo.
pause

:: Nome do processo do jogo
set GAME_PROCESS=VALORANT-Win64-Shipping.exe
...
echo ==================================================
echo Otimizacoes para Valorant aplicadas.
echo ==================================================
pause
exit

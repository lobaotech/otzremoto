@echo off
color 0A
title Otimizador Roblox

echo ==================================================
echo               OTIMIZADOR ROBLOX
echo ==================================================

echo Este script aplica otimizacoes para Roblox.
echo.
pause

:: Nome do processo do jogo
set GAME_PROCESS=RobloxPlayerBeta.exe
...
echo ==================================================
echo Otimizacoes para Roblox aplicadas.
echo ==================================================
pause
exit

@echo off
color 0A
title Otimizador Fortnite

echo ==================================================
echo               OTIMIZADOR FORTNITE
echo ==================================================

echo Este script aplica otimizacoes para Fortnite.
echo.
pause

:: Nome do processo do jogo
set GAME_PROCESS=FortniteClient-Win64-Shipping.exe
...
echo ==================================================
echo Otimizacoes para Fortnite aplicadas.
echo ==================================================
pause
exit
